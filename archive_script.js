...
todoForm.addEventListener('submit', function (e) {
  ...
  if (todoName !== '') {
    ...
    archivedListItem.addEventListener('click', function () {
      // Expand or collapse the archived list item
      archivedListItem.querySelector('details').open = !archivedListItem.querySelector('details').open;
    });

    // Set the data attribute to link the archived list item with the to-do list item
    archivedListItem.setAttribute('data-linked-item', id);
